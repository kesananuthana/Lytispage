        ...
        <div className='our'>
            <div className="services">
                ...
                <div className="services-page">
                    ...
                    <div className="service-card">
                        <h2>IT Consulting</h2>
                        <p> Navigate the complexities of technology with our expert guidance.We analyze your systems, identify opportunities for improvement,and craft tailored strategies that drive growth and efficiency.</p>
                        <Button type="primary" size='large'>ReadMore</Button>
                    </div>
                    <div className="service-card">
